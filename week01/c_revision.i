/* This is the output of `gcc -E c_revision.c -o c_revision.i' on my computer.
 * While this may look confusing, the # comments simply state from which file
 * the following lines of C code came from, whether that is our C code or the
 * libraries already present on the system. */
# 1 "c_revision.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 31 "<command-line>"
...
"str != NULL"
# 16 "c_revision.c" 3 4
, "c_revision.c", 16, __extension__ __PRETTY_FUNCTION__); }))
# 16 "c_revision.c"
                   ;
